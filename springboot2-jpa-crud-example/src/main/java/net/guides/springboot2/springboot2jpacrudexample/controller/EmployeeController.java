...
/*--This is a crontroller class all REST API calls are made from this class*/
...
public class EmployeeController {
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable(value = "id") Long employeeId,
		...
		employee.setStreetaddress(employeeDetails.getStreetaddress());
		...
		employee.setUrl(employeeDetails.getUrl());
		employee.setGraddate(employeeDetails.getGraddate());
